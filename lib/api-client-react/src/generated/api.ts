 ...
 */
export const getUserPublicKey = async (id: number, options?: RequestInit): Promise<PublicKeyResponse> => {
...
export const getGetUserPublicKeyQueryOptions = <TData = Awaited<ReturnType<typeof getUserPublicKey>>, TError = ErrorType<ErrorResponse>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUserPublicKey>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetUserPublicKeyQueryKey(id);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getUserPublicKey>>> = ({ signal }) => getUserPublicKey(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getUserPublicKey>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetUserPublicKey<TData = Awaited<ReturnType<typeof getUserPublicKey>>, TError = ErrorType<ErrorResponse>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUserPublicKey>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const getConversation = async (otherUserId: number, options?: RequestInit): Promise<Message[]> => {
...
export const getGetConversationQueryOptions = <TData = Awaited<ReturnType<typeof getConversation>>, TError = ErrorType<ErrorResponse>>(otherUserId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getConversation>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
 ...
 */
export const sendMessageRequest = async (sendMessageRequestInput: SendMessageRequestInput, options?: RequestInit): Promise<MessageRequestItem> => {
...
export const getSendMessageRequestMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendMessageRequest>>, TError,{data: BodyType<SendMessageRequestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendMessageRequest>>, TError,{data: BodyType<SendMessageRequestInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendMessageRequest>>, {data: BodyType<SendMessageRequestInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SendMessageRequestMutationResult = NonNullable<Awaited<ReturnType<typeof sendMessageRequest>>>
 ...
 * @summary Send a message request to another user
 */
export const useSendMessageRequest = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendMessageRequest>>, TError,{data: BodyType<SendMessageRequestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const listIncomingRequests = async ( options?: RequestInit): Promise<MessageRequestItem[]> => {
...
export const getListIncomingRequestsQueryKey = () => {
    return [
    `/api/message-requests/incoming`
    ] as const;
    }


export const getListIncomingRequestsQueryOptions = <TData = Awaited<ReturnType<typeof listIncomingRequests>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listIncomingRequests>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListIncomingRequestsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listIncomingRequests>>> = ({ signal }) => listIncomingRequests({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listIncomingRequests>>, TError, TData> & { queryKey: QueryKey }
}

export type ListIncomingRequestsQueryResult = NonNullable<Awaited<ReturnType<typeof listIncomingRequests>>>
...
export function useListIncomingRequests<TData = Awaited<ReturnType<typeof listIncomingRequests>>, TError = ErrorType<ErrorResponse>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listIncomingRequests>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const listOutgoingRequests = async ( options?: RequestInit): Promise<MessageRequestItem[]> => {
...
export const getListOutgoingRequestsQueryKey = () => {
    return [
    `/api/message-requests/outgoing`
    ] as const;
    }


export const getListOutgoingRequestsQueryOptions = <TData = Awaited<ReturnType<typeof listOutgoingRequests>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listOutgoingRequests>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListOutgoingRequestsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listOutgoingRequests>>> = ({ signal }) => listOutgoingRequests({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listOutgoingRequests>>, TError, TData> & { queryKey: QueryKey }
}

export type ListOutgoingRequestsQueryResult = NonNullable<Awaited<ReturnType<typeof listOutgoingRequests>>>
...
export function useListOutgoingRequests<TData = Awaited<ReturnType<typeof listOutgoingRequests>>, TError = ErrorType<ErrorResponse>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listOutgoingRequests>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const respondToMessageRequest = async (id: number,
    respondMessageRequestInput: RespondMessageRequestInput, options?: RequestInit): Promise<MessageRequestItem> => {
...
export const getRespondToMessageRequestMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof respondToMessageRequest>>, TError,{id: number;data: BodyType<RespondMessageRequestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof respondToMessageRequest>>, TError,{id: number;data: BodyType<RespondMessageRequestInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof respondToMessageRequest>>, {id: number;data: BodyType<RespondMessageRequestInput>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RespondToMessageRequestMutationResult = NonNullable<Awaited<ReturnType<typeof respondToMessageRequest>>>
    export type RespondToMessageRequestMutationBody = BodyType<RespondMessageRequestInput>
    export type RespondToMessageRequestMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Accept or reject an incoming message request
 */
export const useRespondToMessageRequest = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof respondToMessageRequest>>, TError,{id: number;data: BodyType<RespondMessageRequestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getGetMessageStatsQueryOptions = <TData = Awaited<ReturnType<typeof getMessageStats>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMessageStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetMessageStats<TData = Awaited<ReturnType<typeof getMessageStats>>, TError = ErrorType<ErrorResponse>>(
